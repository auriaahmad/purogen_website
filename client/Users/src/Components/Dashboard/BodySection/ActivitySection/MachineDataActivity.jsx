...
const ParticularCustomerMachineData = ({ onClose, selectedMachineData, userProfileData }) => {
  ...
  const downloadPDF = () => {
    ...
    doc.save(`${userProfileData.first_name}_${userProfileData.last_name}_Machines.pdf`);
  };
  ...
  const downloadExcel = () => {
    ...
    XLSX.writeFile(wb, `${userProfileData.first_name}_${userProfileData.last_name}_Machines.xlsx`);
  };
