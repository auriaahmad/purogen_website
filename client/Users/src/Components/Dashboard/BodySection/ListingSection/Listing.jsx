...
import ParticularUserMachineData from '../ActivitySection/MachineDataActivity';
...
const Listing = ({ machines }) => {
  ...
  const handleRowClick = (machine) => {
    ...
    axios.get(`http://localhost:3006/particularUserMachineData/${user_id}/${machine.machine_register_id}`, { withCredentials: true })
      .then(response => {
